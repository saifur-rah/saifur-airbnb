...
function InfoCard({ img, location, title, description, star, price, total }) {
  return (
    <div className="flex py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg transition duration-200 ease-out first:border-t">
      <div className="relative h-50 sm:h-16 w-40 md:h-52 md:w-80 flex-shrink-0">
        <Image
          src={img}
          layout="fill"
          objectFit="cover"
      ...
      <div className="flex flex-col flex-grow pl-5">
        <div className="  flex justify-between">
          <p>Fully Sanitized Rooms Available</p>
        ...
        <div className="flex justify-between items-end pt-5">
          ...
          <div>
            <p className="text-lg lg:text-2xl font-semibold sm:pb-2 p-2">{price}</p>
